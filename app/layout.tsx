...
export const metadata: Metadata = {
  ...
  description: `${site.school} ${site.event} ${site.year} için ekip başvuruları açıldı. Sanattan hukuka, felsefeden ilahiyata disiplinlerin akıntısında düşün, sorgula, üret.`,
  openGraph: {
    title: fullTitle,
