...
export const metadata: Metadata = {
  title: `Sarnıç Akıntısı · ${site.event} ${site.year}`,
};
 ...
 * teams.intro'nun tamamını hero'ya koymak yanlıştı: ilk cümle ("Çalıştayı
 * hazırlayan ekipler ve başkanları.") bir BÖLÜM girişi, hero cümlesi değil —
 * hero'da öznesiz bir başlık gibi asılı kalıyordu. Son cümle ise tam olarak
 * bu sayfanın işini anlatıyor: başvurunca ne oluyor.
...
export default function SarnicAkintisiSayfasi() {
  return (
