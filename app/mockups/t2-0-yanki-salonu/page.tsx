...
import { YankiSalonu } from "./YankiSalonu";
...
export const metadata: Metadata = {
  title: `Yankı Salonu · ${site.event} ${site.year}`,
};
 ...
 * başvurunca ne oluyor. İlk cümle ("Çalıştayı hazırlayan ekipler ve
 * başkanları.") bir BÖLÜM girişi, hero cümlesi değil.
...
export default function YankiSalonuSayfasi() {
  return (
